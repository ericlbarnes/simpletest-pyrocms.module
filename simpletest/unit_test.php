 ...
 */
define('MAIN_PATH', str_replace('/third_party/modules/simpletest', '', realpath(dirname(__FILE__))).'/');

define('EXTPATH', MAIN_PATH .'third_party/modules/');
define('SIMPLETEST', EXTPATH .'simpletest/tests/simpletest/');
define('TESTS_DIR', EXTPATH .'simpletest/tests/');
define('ROOT', MAIN_PATH);
define('APP_DIR', MAIN_PATH .'/application/');
define('ENV', 'local');
